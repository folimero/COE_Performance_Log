<?php
  ...
  if (isset($_SESSION["usuarioNombre"])) {
      if (!in_array(38, $_SESSION["permisos"])) {
...
<!DOCTYPE html>
    <div class="flex-container w-100 mt-3">
        <div class="card shadow p-3 bg-body rounded w-100 m-0">
          <div class="card-header bg-warning text-center text-black fw-bold">
              <h3>Application Support Project Register</h3>
          </div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <div class="input-field">
                          ...
                          <label for="empleadoDiseno">Activity Resp.</label>
                          <div class="">
                            <div class="inline-container">
                              <select name="empleadoDiseno" id="respDiseno" required>
                                <option disabled selected value> -- Select -- </option>
                                <?php
    ...
    <script src="proyecto_alta_application_support_func.js"></script>
