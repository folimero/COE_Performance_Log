        ...
        if (!in_array(7, $_SESSION["permisos"]) && !in_array(8, $_SESSION["permisos"])) {
            ...
            if (isset($_POST['filtro'])) {
                ...
                $stmt = $dbh->prepare("SELECT idProyecto, projectID, cliente.nombreCliente, proyecto.nombre AS pnombre, proyecto.descripcion, DATE(proyecto.fechaCrea) AS fechaCrea,
                                      ...
                                      proyecto.awarded, (SELECT empleado.nombre FROM empleado WHERE empleado.idEmpleado = proyecto.idRepreVentas) AS salesRep,
...
<!DOCTYPE html>
    ...
    <div class="card mt-3 mb-3">
        <h2 class="card-header text-center bg-primary text-white">COE Project History</h2>
        <div class="card-body">
            <div class="row">
              <form class="" action="proyecto_history_coe.php" style="width: 100%;" method="post">
                <div class="row mb-4">
                  <div class="col-6">
              ...
              <table id="projectHistoryTable" class="table">
                  ...
                  <tbody>
                      ...
                      while ($resultado = $stmt->fetch()) {
                          ...
                          echo "<td>". $resultado->pnombre;
                              if ($resultado->pendAct > 0) {
                                  echo '<span class="badge bg-danger">'.$resultado->pendAct.'</span>';
                              }
                          echo "</td>";
                          echo "<td>". $resultado->salesRep . "</td>";
                          // echo "<td>". $resultado->descripcion . "</td>";
                          echo "<td>". $resultado->tiponombre . "</td>";
                          echo "<td>". $resultado->cnombre . "</td>";
                          // echo "<td>". $resultado->cobrarA . "</td>";
                          // echo "<td>". $resultado->ventasPotenciales . "</td>";
                          // echo "<td>". $resultado->PO . "</td>";
                          // echo "<td>". $resultado->qtoNumber . "</td>";
                          // echo "<td>". $resultado->carrier . " " . $resultado->cuenta . "</td>";
                          // echo "<td>". $resultado->tracking . "</td>";
                          // echo "<td>". $resultado->responsable . "</td>";
                          // echo "<td>". $resultado->sobreCarga * 100 . "%</td>";
                          ...
                          //         </a>
                          //       </td>";
                          echo "<td>". $resultado->longestETA . "</td>";
