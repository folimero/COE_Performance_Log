    ...
    success:function(response) {
      if (!response != "error") {
        ...
        // console.log(info);
          ...
          $("#cobrarA option[value=" + info.result.cobrarA + "]").attr('selected', 'selected');
          recargarLista();
          $("#cuenta option[value=" + info.result.idCuenta + "]").attr('selected', 'selected');
          $('#tracking').val(info.result.tracking);
          $('#appTrackID').val(info.result.appTrackID);
          ...
          $('#olverLoad').val(info.result.sobreCarga);
          $("#respDiseno option[value=" + info.result.idRespDiseno + "]").attr('selected', 'selected');
          $("#respManu option[value=" + info.result.idRespManu + "]").attr('selected', 'selected');
          ...
          $("#idProjectManager option[value=" + info.result.idGerenteProyecto + "]").attr('selected', 'selected');
          $("#idProjectCoordinator option[value=" + info.result.idCoordinadorProyecto + "]").attr('selected', 'selected');
          $("#idQAEngineer option[value=" + info.result.idIngenieroQA + "]").attr('selected', 'selected');

          $("#backIcon").attr("href", "../../pages/proyecto_detalle/proyecto_detalle_coe.php?id=" + id);
