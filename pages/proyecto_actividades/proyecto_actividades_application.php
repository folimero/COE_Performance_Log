<?php
  ...
  if (isset($_GET['id'])) {
      ...
      $stmt = $dbh->prepare("SELECT idProyecto, nombre, descripcion, idRespDiseno
                            FROM proyecto
                            WHERE idProyecto = $id");
      $stmt->execute();
 ...
 ?>
      ...
      <div class="flex-container">
        <h1>Project</h1>
        <a href='../proyecto_detalle/proyecto_detalle_application.php?id=<?php echo $id  ?>'>
...
<?php
          while ($resultado = $stmt->fetch()) {
              ...
              <div class="" style="width: 500px;">
                ...
                <input id="idRespDiseno" name="idRespDiseno" type="hidden" style="text-align:center; font-weight:bold; background-color: AliceBlue;" value="<?php echo $resultado->idRespDiseno; ?>" disabled>
              </div>
<?php
          } ?>
        ...
        <script type="text/javascript">
            ...
            function asignarActividades(e) {
              ...
              var idRespDiseno = $('#idRespDiseno').val();
